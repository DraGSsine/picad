...
const SubscriptionDialog = () => {
  ...
  const plans = [
    {
      name: "Starter",
      description:
        "Perfect for individuals creating occasional marketing content with AI.",
      price: 9.99,
      period: "month",
      features: [
    ...
    },
    {
      name: "Growth",
      description:
        "Ideal for regular content creators needing more generations and faster support.",
      price: 19.99,
      period: "month",
      features: [
    ...
    },
    {
      name: "Annual",
      description:
        "Same as monthly Growth plan but with two months free! Best value for your business.",
      price: 199.99,
      period: "year",
  ...
  return (
    <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50 animate-in fade-in duration-300 overflow-hidden">
      <div className=" rounded-md  bg-yellow-200 overflow-hidden">
        <div className="bg-background/95 border border-primary/20 p-8 max-w-7xl w-full max-h-[90vh] custom-scrollbar shadow-2xl relative">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 relative z-10">
            {plans.map((plan, index) => (
              ...
              >
                {/* Popular badge */}
                {plan.popular && (
                  <Badge className="absolute -top-3 right-6 bg-gradient-to-r from-primary to-primary/90 hover:from-primary/90 hover:to-primary/80 text-white border-none shadow-md px-4 py-1">
                    Most Popular
                  </Badge>
                )}
                ...
                <div className="mb-6">
                  ...
                  <p className="text-foreground/70 mb-6 h-12">
                    {plan.description}
                  </p>
