  ...
  return (
    <div className="fixed top-0 left-0 right-0 z-50">
      <div className="container mx-auto px-4 pt-6">
        <nav
          className="rounded-full px-4 sm:px-6 md:px-8 py-2 bg-white/90 backdrop-blur-md shadow-md border border-slate-200/60 dark:bg-slate-900/80 dark:border-slate-800/60"
        >
        ...
        {isMenuOpen && (
          <div className="md:hidden fixed inset-x-0 top-[88px] mx-4 bg-white/95 dark:bg-slate-900/95 backdrop-blur-md rounded-2xl shadow-xl border border-slate-200/30 dark:border-slate-800/30 overflow-hidden z-50">
              ...
              <div className="flex flex-col space-y-3">
                ...
                <div className="grid gap-3 pt-3">
                  <Link href="/auth/signin">
                    <Button
                      variant="outline"
                      className="w-full text-foreground hover:bg-slate-100 dark:hover:bg-slate-800/70 border-slate-200 dark:border-slate-800 rounded-xl py-5 font-medium"
                    >
                      Sign In
                    </Button>
                  </Link>
                  <Link href="/auth/signup">
                    <Button className="w-full bg-primary hover:bg-primary/90 text-primary-foreground rounded-xl py-5 shadow-md font-semibold">
                      Get Started
                    </Button>
                  </Link>
                </div>
